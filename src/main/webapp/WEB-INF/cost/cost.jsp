...
<script language="javascript" type="text/javascript">
            ...
            $(function(){
            	var duration=$("#baseDurationSort").val().trim();
            	var baseCost=$("#baseCostSort").val().trim();
            	if(duration!=""){
            		$("#baseDuration").attr("class","sort_"+duration);
            	}
            	if(baseCost!=""){
            		$("#baseDurationSort").val("");
            		$("#baseCost").attr("class","sort_"+baseCost);
            	}
            });
            //排序按钮的点击事件
		...
		<form id="costForm" action="findCost.do" method="post">
			...
			<div class="search_add">
			 <div>
				...
				<input type="hidden" name="baseDuration" id="baseDurationSort" value="${costPage.baseDuration }"/>
				<input type="hidden" name="baseCost" id="baseCostSort" value="${costPage.baseCost }"/>
				
				<input id="baseDuration" type="button" value="时长"  class="sort_asc" onclick="sort(this);" />
